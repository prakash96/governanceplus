package com.governanceplus.ai.config;

import com.governanceplus.ai.ChatEngine;
import com.governanceplus.ai.ModelService;
import com.governanceplus.ai.service.MockChatEngine;
import com.governanceplus.ai.service.UnavailableChatEngine;
 ...
 * instead of per-request the way a CLI would — loading a GGUF model is too
 * expensive to repeat per HTTP request.
 *
